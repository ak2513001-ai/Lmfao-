(function() {
    ...
    function spawn(){const a=geofs.aircraft.instance;let pos;try{pos=a.object3d.lla}catch(e){pos=a.llaLocation}S.lat=pos[0];S.lon=pos[1];S.hdg=a.heading||0;S.pitch=0;S.alt=gnd(S.lon,S.lat)+1.6;S._t0=performance.now();S._bob=0}
